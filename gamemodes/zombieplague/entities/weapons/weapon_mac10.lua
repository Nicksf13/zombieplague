...
if ( CLIENT ) then       
	killicon.AddFont( "weapon_mac10", "CSKillIcons", "l", Color( 255, 80, 0, 255 ) )
...
function SWEP:DrawWeaponSelection( x, y, wide, tall, alpha )
	draw.SimpleText( self.IconLetter, "CSSelectIcons", x + wide/2, y + tall*0.1, Color( 255, 210, 0, 255 ), TEXT_ALIGN_CENTER )
end
