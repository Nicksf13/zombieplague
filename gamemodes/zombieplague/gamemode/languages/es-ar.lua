local Language = {PrettyName = "Español Latino-america",
	Values = 
	{
		Server = {
			...
			NoticeVotemapProlong = "O Se extendera por otra %s ronda(s)!",
			NoticeNotAllowed = "O El mapa se extendera por mas tiempo!",
		...
		Client = {
			...
			MenuClose = "Cerrar",
			MenuCredit = "Créditos",
			MenuCreditMeRcyLeZZ = "MeRcyLeZZ - Creador del gamemode de CS 1.6",
			MenuCreditZombiePlague = "Zombie Plague - Post Original",
			MenuCreditTheFireFuchs = "The Fire Fuchs - Creador del gamemode de Garry's mod",
			MenuCreditErickMaksimets = "Erick Maksimets - Ayuda reportando bugs, con traduccion en ruso, ucraniano! ayuda a dar ideas para mas contenido!",
            MenuCreditBlueberryy = "Blueberryy - Actualizado o READ.ME en el projecto github",
            MenuCreditPac = "PacUGC3 - Hizo la traducción al español",
			Nemesis = "Nemesis",
			...
			ZombieLeechClassDescription = "Gana 250 HP por cada humano infectado.",
