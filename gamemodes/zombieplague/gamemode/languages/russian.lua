local Language = {PrettyName = "Русский",
	Values = 
	{
		...
		Client = {
			...
			HumanHeavyClassDescription = "Оставайтесь под защитой от зомби благодаря броне.",
			...
			KeyBindingDefault = "Восстановить стандартные настройки",
			...
			ZPHUDCustomizer = "Меню кастомизации HUD",
