...
Dictionary:RegisterPhrase("ru", "ExtraItemHarpoonName", "Гарпун", false)
Dictionary:RegisterPhrase("uk", "ExtraItemHarpoonName", "Гарпун", false)
...
Dictionary:RegisterPhrase("ko", "ExtraItemHarpoonName", "작살", false)