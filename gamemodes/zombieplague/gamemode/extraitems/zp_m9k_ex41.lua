...
Dictionary:RegisterPhrase("ru", "ExtraItemEX41Name", "EX-41", false)
Dictionary:RegisterPhrase("uk", "ExtraItemEX41Name", "EX-41", false)
...
Dictionary:RegisterPhrase("ko", "ExtraItemEX41Name", "EX-41", false)