	...
	local Language = {PrettyName = "US English",
		Values = 
		{
			Server = {
				...
				ExtraItemCategoryBuff = "Buff",
				ExtraItemCategoryWeapon = "Weapon",
				ExtraItemCategoryUtility = "Utility",
			...
			Client = {
				...
				VGUIMenuOrderBy = "Order By",
				VGUIWeaponChooseMenuOrderByNameAsc = "Name - ASC",
				VGUIWeaponChooseMenuOrderByNameDesc = "Name - DESC",
				VGUIWeaponChooseMenuOrderByCategoryAsc = "Category - ASC",
				VGUIWeaponChooseMenuOrderByCategoryDesc = "Category - DESC",
				VGUIClassChooseMenuOrderByNameAsc = "Name - ASC",
				VGUIClassChooseMenuOrderByNameDesc = "Name - DESC",
				VGUIClassChooseMenuOrderByHealthAsc = "Health - ASC",
				VGUIClassChooseMenuOrderByHealthDesc = "Health - DESC",
				VGUIClassChooseMenuOrderByArmorAsc = "Armor - ASC",
				VGUIClassChooseMenuOrderByArmorDesc = "Armor - DESC",
				VGUIClassChooseMenuOrderBySpeedAsc = "Speed - ASC",
				VGUIClassChooseMenuOrderBySpeedDesc = "Speed - DESC",
				VGUIClassChooseMenuOrderByGravityAsc = "Gravity - ASC",
				VGUIClassChooseMenuOrderByGravityDesc = "Gravity - DESC",
				VGUIClassChooseMenuOrderByHasAbilityAsc = "Has ability - ASC",
				VGUIClassChooseMenuOrderByHasAbilityDesc = "Has ability - DESC",
				VGUIExtraItemsMenuOrderByNameAsc = "Name - ASC",
				VGUIExtraItemsMenuOrderByNameDesc = "Name - DESC",
				VGUIExtraItemsMenuOrderByCategoryAsc = "Category - ASC",
				VGUIExtraItemsMenuOrderByCategoryDesc = "Category - DESC",
				VGUIExtraItemsMenuOrderByPriceAsc = "Price - ASC",
				VGUIExtraItemsMenuOrderByPriceDesc = "Price - DESC"
			}
		},
		Order = 0
	}
