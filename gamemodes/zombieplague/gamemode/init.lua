...
include("sv_particlemanager.lua")
...
AddCSLuaFile("cl_particlemanager.lua")
AddCSLuaFile("cl_menu.lua")
AddCSLuaFile("cl_keymanager.lua")
AddCSLuaFile("cl_derma.lua")
AddCSLuaFile("cl_scoreboard.lua")
AddCSLuaFile("zombieplague/gamemode/vgui/components/vgui_keybinding.lua")
AddCSLuaFile("zombieplague/gamemode/vgui/components/vgui_hudcustomizer.lua")
AddCSLuaFile("zombieplague/gamemode/vgui/components/utils/DTitlemenu.lua")
AddCSLuaFile("zombieplague/gamemode/vgui/components/utils/DCenteredLabel.lua")
AddCSLuaFile("zombieplague/gamemode/vgui/components/utils/DTitledModelPanel.lua")
AddCSLuaFile("zombieplague/gamemode/vgui/components/utils/DFilterScrollPanel.lua")

AddCSLuaFile("zombieplague/gamemode/vgui/components/menus/cl_weaponchoosemenu.lua")
AddCSLuaFile("zombieplague/gamemode/vgui/components/menus/cl_classchoosemenu.lua")
AddCSLuaFile("zombieplague/gamemode/vgui/components/menus/cl_extraitemsmenu.lua")
